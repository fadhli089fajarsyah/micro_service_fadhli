            ...
            <nav className='bg-black flex text-white justify-between items-center py-2 px-2 md:px-9  lg:py-3 z-50 fixed w-full'>
                ...
                <div className='flex w-[50%] justify-end items-center'>
                    <ul className='flex pr-4'>
                        ...
                        <li><a href='' className='text-[15px] lg:text-[20px] border-x px-2 mx-2'>Paslon</a></li>
                        <li><a href='' className='text-[15px] lg:text-[20px]'>Voting</a></li>
                    </ul>
                    {login ? (
                        <h1 className='bg-white text-black rounded-full p-1 px-3' onClick={handleLogin} >Y</h1>
                    ) : (
                        <button onClick={handleLogin} className='text-[15px] lg:text-[20px] bg-white text-black font-bold rounded px-2 py-1 md:px-3 md:py-01 lg:px-6 text-center items-center flex'>Login</button>
                    )}
                </div>
            </nav>
        </>
