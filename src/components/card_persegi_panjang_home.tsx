...
function CardPersegiPanjang() {
    ...
    return (
        <a href='detail' className=" w-[200px] h-[100px] mb-2 mt-2 md:w-[360px] md:h-[200px] lg:w-[650px] lg:h-[422px] bg-cover bg-center lg:my-10 lg:mx-2 " style={{ backgroundImage: `url(${bg})` }}>
