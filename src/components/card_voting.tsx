    ...
    return (
        <>
            {card ? (
                ...
                <button onClick={handleCard} className="lg:w-[30%] p-[1.5%] pt-9 flex flex-col items-center bg-[#FCFF63] rounded-xl m-4  shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px]">
                    <div className="text-start">
                        <div className="relative">
                            <img src={Monkey} alt="" className="" />
                            <h1 className="absolute lg:top-[-30px] lg:right-[-17px] lg:p-5 lg:px-9 text-[32px]  rounded-full border-white border-4 text-white bg-[#FF6384]">1</h1>
                        </div>
